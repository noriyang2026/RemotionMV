...
// ============================================================
// VTuber0306 Composition — Video + CRT + Typelog
// ============================================================
export const VTuber0306: React.FC = () => {
    const subtitles: TypelogEntry[] = require('./data/vtuber0306_subtitles.json');
    ...
    return (
        <AbsoluteFill style={{ backgroundColor: '#000' }}>
            <CyberpunkCRTEffect>
                {/* Video */}
                <Video
                    src={staticFile('videos/vtuber0306.mp4')}

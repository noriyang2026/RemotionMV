/**
 * CharlotteOfuse.tsx
 * ── シャルロット × お布施 配信風 LIVE テロップ ──
 *
 * CharlotteEntame.tsx の演出構成を流用:
...
const SUBS: SubLine[] = [
  {
    ...
    startSec: 0.0,
    endSec: 4.5,
    yellowHighlights: ['月額1万で教えるAIサロン！'],
  },
  {
    id: 's2',
    text: '「限定メルマガで成功に導く！」\nみたいなテンプレ商売を始めたら',
  ...
  },
  {
    ...
    startSec: 30.0,
    endSec: 34.0,
    yellowHighlights: ['これを買えばあなたも稼げますよ（笑）'],
  },
  {
    id: 's9',
    text: 'っていう\n情報弱者からの搾取でしょ？',
...
// ══════════════════════════════════════════════════════════════
// CyberpunkOverlay — Scanlines + Vignette
// ══════════════════════════════════════════════════════════════
...
// 🎬 Main Composition
// ══════════════════════════════════════════════════════════════
export const CharlotteOfuse: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: '#000' }}>
      <CyberpunkOverlay>
        <Video
          src={staticFile('videos/お布施_1.mp4')}
